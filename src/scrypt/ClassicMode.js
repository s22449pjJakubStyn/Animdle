...
// Obliczanie procentowego postępu
                        ...
                        if (attempts === 1) {
                            ...
                            try {
                                ...
                                if (!achievementData || !achievementData.userUID || !achievementData.userUID.includes(currentUser.uid)) {
                                    ...
                                    toast.success("Well done, you've unlocked the '🥵 Crazy mangaka' achievement! You have been awarded 10 points");
                                }
                            } catch (error) {
        ...
        return (
            <div className="App">
                ...
                {attempts >= 6 && randomCharacter.hintEasy && (
                    <div className="Hint">Little hint: {randomCharacter.hintEasy}</div>
                )}
                {attempts >= 11 && randomCharacter.hintHard && (
